...
- [ ]  Study: [The Flask User Guide](http://flask.pocoo.org/docs/0.12/) - yes, all of it, do the tutorials, read it all. Then investigate how to integrate it with the frontend framework or library of your choice (Angular, Vue or React).
